...
## TODO:
* Add specs and instructions to readme for array usage (sequential commands) eg : on a trade object:

comma do
 bid  [:creator, :name, :to_s, :titleize]
 buyer
 seller

end

will sequentially run the commands on the initial item, great for complex relationships
